...
ob_start();
?>
    <div style="background-image: url(public/img/n1.JPG); background-repeat: no-repeat;background-size: 1500px; height: 400px"  class=" mx-auto text-center">
                            ...
                            <div class="col-md-4">
                                <div class="item-box-blog">
                                    <div class="item-box-blog-image">
                                        <!--Date-->
                                        <!--Image-->
                                        <figure> <img alt="" src="public/img/slide2.JPG"> </figure>
                                    </div>
                                    <div class="item-box-blog-body">
                                        <!--Heading-->
                                        <div class="item-box-blog-heading">
                            ...
                            <div class="col-md-4">
                                <div class="item-box-blog">
                                    <div class="item-box-blog-image">
                                        <!--Date-->
                                        <!--Image-->
                                        <figure> <img alt="" src="public/img/slide5.JPG"> </figure>
                                    </div>
                                    <div class="item-box-blog-body">
                                        <!--Heading-->
                                        <div class="item-box-blog-heading">
